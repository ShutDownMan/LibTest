...
import com.example.libtest.CodecManager.Codec;
...
public class EncoderDebugger {
    ...
    /** Prefix that will be used for all shared preferences saved by VidStreamer. */
    private static final String PREF_PREFIX = "vidstreamer-";
